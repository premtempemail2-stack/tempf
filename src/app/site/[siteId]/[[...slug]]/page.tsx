          ...
          sections: [
            { 
              ...
              props: { 
                ...
                description: 'This is a published website created with WebBuilder.',
              } 
            },
...
export default async function PublishedSitePage({ params }: PageProps) {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-950">
        <div className="text-center">
          ...
          <p className="text-gray-400">This site doesn&apos;t exist or hasn&apos;t been published yet.</p>
        </div>
      </div>
    );
  }
  ...
  const currentPage = content.pages.find(p => p.slug === currentPath) || content.pages[0];
